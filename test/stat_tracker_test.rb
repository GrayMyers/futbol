...
class StatTrackerTest < Minitest::Test
  ...
  def test_existence
    ...
    st = StatTracker.new(locations)
    self_st = StatTracker.from_csv(locations)

    assert_instance_of StatTracker, self_st
  ...
  def test_it_has_attributes
    ...
    st = StatTracker.new(locations)
    assert_instance_of ObjectData, st.object_data
    assert_instance_of MeanMethods, st.mean
    assert_instance_of ExtremaMethods, st.extrema
  end
  ...
  def test_rival
    ...
    assert expected.include?(@stat_tracker.rival("18"))
  end
  ...
  def test_worst_coach
    ...
    assert expected.include?(@stat_tracker.worst_coach("20142015"))
